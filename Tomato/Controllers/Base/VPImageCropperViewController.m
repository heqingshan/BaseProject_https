...
- (void)initControlBtn {
    ...
    cancelBtn.backgroundColor = NavigationBg_Color;
    ...
    UIButton *confirmBtn = [[UIButton alloc] initWithFrame:CGRectMake(self.view.frame.size.width/2 + 1, self.view.frame.size.height - 50.0f, self.view.frame.size.width/2, 50)];
    confirmBtn.backgroundColor = NavigationBg_Color;
